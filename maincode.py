...
num1 = st.number_input("Enter the first number:", value=0.0, step=None, format='%f', key='num1', min_value=0.0)
num2 = st.number_input("Enter the second number:", value=0.0, step=None, format='%f', key='num2', min_value=0.0)
num3 = st.number_input("Enter the third number:", value=0.0, step=None, format='%f', key='num3', min_value=0.0)
